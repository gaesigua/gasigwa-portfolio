...
The term "internet" means "interconnected network." A network is a set of interconnected computer networks that utilize 
standardized protocols to communicate. 
...
4. Security: Some protocols, like HTTPS provide encryption and security features. 
