...
- Increased the height of the logo on both mobile and desktop (`src/components/Layout.jsx`) using Tailwind CSS classes (`h-12 md:h-16`).
- Reduced the vertical padding of the header (`py-2.5 md:py-1.5`) to offset the larger logo height, keeping the total header layout height exactly as it was.
